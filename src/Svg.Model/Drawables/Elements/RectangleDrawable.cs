...
namespace Svg.Model.Drawables.Elements
{
    public sealed class RectangleDrawable : DrawablePath
    {
        ...
        public static RectangleDrawable Create(SvgRectangle svgRectangle, SKRect skOwnerBounds, DrawableBase? parent, IAssetLoader assetLoader, Attributes ignoreAttributes = Attributes.None)
        {
