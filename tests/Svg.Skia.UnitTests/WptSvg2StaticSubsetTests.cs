...
public class WptSvg2StaticSubsetTests : SvgUnitTest
{
    public static IEnumerable<object[]> StaticSubsetRows()
    {
        ...
        yield return Row("painting/currentColor-override-pserver-fallback.svg", 0.022, 300, 150);
        yield return Row("painting/currentColor-override-pserver-fill.svg", 0.022, 300, 150);
        yield return Row("painting/currentColor-override-pserver-stroke.svg", 0.09, 300, 150);
        yield return Row("path/bearing/absolute.svg", 0.022, 200, 200);
        yield return Row("path/bearing/relative.svg", 0.022, 200, 200);
        yield return Row("path/bearing/zero.svg", 0.022, 100, 100);
        ...
        yield return Row("shapes/circle-01.svg", 0.022, 100, 100);
        yield return Row("shapes/ellipse-01.svg", 0.022, 100, 100);
        yield return Row("shapes/ellipse-02.svg", 0.022, 100, 100);
        yield return Row("shapes/ellipse-03.svg", 0.022, 100, 100);
        yield return Row("shapes/ellipse-04.svg", 0.022, 100, 100);
        yield return Row("shapes/ellipse-05.svg", 0.022, 100, 100);
        yield return Row("shapes/ellipse-06.svg", 0.022, 100, 100);
        yield return Row("shapes/ellipse-07.svg", 0.022, 240, 160);
        yield return Row("shapes/ellipse-08.svg", 0.022, 240, 160);
        yield return Row("shapes/ellipse-09.svg", 0.022, 100, 100);
        yield return Row("shapes/rect-05.svg", 0.022, 100, 100);
        yield return Row("shapes/rect-rx-set-by-css.svg", 0.022, 100, 100);
        yield return Row("styling/render/transform-origin-not-explicit-style-visual.svg", 0.022, 300, 200);
