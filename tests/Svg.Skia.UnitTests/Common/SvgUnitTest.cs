...
public abstract class SvgUnitTest
{
    protected static string GetFontsPath(string name)
        => Path.Combine("..", "..", "..", "..", "..", "externals", "resvg", "crates", "resvg", "tests", "fonts", name);
    ...
    protected void SetTypefaceProviders(SKSvgSettings settings)
    {
        if (settings.TypefaceProviders is { })
        {
            ...
            settings.TypefaceProviders.Insert(0, new CustomTypefaceProvider(GetFontsPath("CFF-and-SBIX.otf")));
            settings.TypefaceProviders.Insert(0, new CustomTypefaceProvider(GetFontsPath("MPLUS1p-Regular.ttf")));
            settings.TypefaceProviders.Insert(0, new CustomTypefaceProvider(GetFontsPath("NotoColorEmojiCBDT.subset.ttf")));
            settings.TypefaceProviders.Insert(0, new CustomTypefaceProvider(GetFontsPath("NotoColorEmojiCOLR.subset.ttf")));
            ...
            settings.TypefaceProviders.Insert(0, new CustomTypefaceProvider(GetFontsPath("NotoSansDevanagari-Regular.ttf")));
            ...
            settings.TypefaceProviders.Insert(0, new CustomTypefaceProvider(GetFontsPath("NotoSansMalayalam-Regular.ttf")));
            ...
            settings.TypefaceProviders.Insert(0, new CustomTypefaceProvider(GetFontsPath("NotoZnamennyMusicalNotation-Regular.ttf")));
            settings.TypefaceProviders.Insert(0, new CustomTypefaceProvider(GetFontsPath("RobotoFlex.subset.ttf")));
            ...
            settings.TypefaceProviders.Insert(0, new CustomTypefaceProvider(GetFontsPath("TwitterColorEmoji.subset.ttf")));
